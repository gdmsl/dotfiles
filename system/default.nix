...

{
  ...
  # (The noctalia lock screen is the exception — it claims the fprintd sensor
  # directly rather than going through pam_fprintd, so on the lock screen the
  # finger and the password field are live at the same time.)
